<header>
        <div class="header_wrapper">
            ...
            <? if (!isset($_SESSION['USER'])) { ?>
                <a class="btn_auth" href="?page=login">Авторизация</a>
                <a class="btn_reg" href="?page=regist">Регистрация</a>
                <? }
                if (isset($_SESSION['USER'])) { ?>
                <a href="?page=basket" class="icons">
                ...
                <a href="?page=profile" class="icons">
                ...
                <? }
                if (isset($_SESSION['USER']) && (int) $USER['role'] == 2) { ?>
                <a class="border_bottom" href="?page=admin">Админ панель</a>
                <? }
                if (isset($_SESSION['USER'])) { ?>
